...
urlpatterns = [
    ...
    path('special_schedules/', views.SpecialScheduleList.as_view(), name='special_schedules_list'),
    path('special_schedules/create', views.SpecialScheduleCreate.as_view(), name='special_schedules_create'),
    path('special_schedules/delete/<int:pk>', views.SpecialScheduleDelete.as_view(), name='special_schedules_delete'),
